...
$zip = "C:\Users\pc\Downloads\PROYECTO_COMPLETO_MONSTERASP_V89_PORTABLE.zip"
...
try {
    ...
    [pscustomobject]@{
        ...
        Files = $names.Count
        BackendDll = $names -contains "RegistroAgencias.SqlServer.V89.dll"
