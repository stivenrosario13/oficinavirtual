...
writeFileSync('output/pdf/formulario_v273_dos_firmas.pdf',Buffer.from(pdf.output('arraybuffer')));
...
writeFileSync('output/pdf/plantilla_conduce_institucional_v273.pdf',Buffer.from(template.output('arraybuffer')));
